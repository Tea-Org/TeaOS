...
//          $HOME_DIRECTORY = array('user1' => '/home/user1', 'user2' => '/home/user2');
    $HOME_DIRECTORY = '../../home/' . $userinfo['unik'];
    ...
    if (array_key_exists('REQUEST_METHOD', $_SERVER) && $_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        <div class="configure">
            ...
            <ul>
                ...
                <li>At the beginning of the file enter your <span class="variable">$USER</span> and <span
            ...
            <p>For more information visit Web Console website: <a
                        href="http://web-console.org">http://web-console.org</a>
            </p>
        </div>
        </body>
        </html>
            ...
            <script type="text/javascript">!function (a, b) {
                    ...
                    var H = a.document, I = a.navigator, J = a.location, K = function () {
                        ...
                        var d, e, f, g, h = function (a, b) {
                            ...
                            w = /(mozilla)(?:.*? rv:([\w.]+))?/, x = /-([a-z]|[0-9])/gi, y = /^-ms-/,
                            z = function (a, b) {
                    ...
                    K.extend({
                        ...
                        data: function (a, c, d, e) {
                            if (K.acceptData(a)) {
                                var f, g, h, i = K.expando, j = "string" == typeof c, k = a.nodeType,
                                    l = k ? K.cache : a,
                    ...
                    K.fn.extend({
                        ...
                        valHooks: {
                            option: {
                                ...
                                get: function (a) {
                                    var b, c, d, e, f = a.selectedIndex, g = [], h = a.options,
                                        i = "select-one" === a.type;
                                    if (0 > f) return null;
                    ...
                    Ca.optgroup = Ca.option, Ca.tbody = Ca.tfoot = Ca.colgroup = Ca.caption = Ca.thead, Ca.th = Ca.td, K.support.htmlSerialize || (Ca._default = [1, "div<div>", "</div>"]), K.fn.extend({
                        ...
                        clone: function (a, b, c) {
                            var d, e, f,
                                g = K.support.html5Clone || !ya.test("<" + a.nodeName) ? a.cloneNode(!0) : r(a);
                            ...
                            for (var f, g, h = [], i = 0; null != (g = a[i]); i++) if ("number" == typeof g && (g += ""), g) {
                                if ("string" == typeof g) if (va.test(g)) {
                                    g = g.replace(sa, "<$1></$2>");
                                    var j = (ta.exec(g) || ["", ""])[1].toLowerCase(), k = Ca[j] || Ca._default,
                                        l = k[0],
                    ...
                    "getBoundingClientRect" in H.documentElement ? K.fn.offset = function (a) {
                        ...
                        bodyOffset: function (a) {
                            ...
                            var e, f, g = K(a), h = g.offset(), i = K.css(a, "top"), j = K.css(a, "left"),
                                k = ("absolute" === d || "fixed" === d) && K.inArray("auto", [i, j]) > -1, l = {},
                                m = {};
                    ...
                    a.fn.cmd = function (c) {
                        ...
                        var w, x, C, D, E, F, G, H, I, J = t.find(".prompt"), K = !1, L = "", M = null,
                            N = c.mask || !1,
                            ...
                            id: function () {
                                ...
                                try {
                                    ...
                                    if (a.each(da, function (c, d) {
                                        ...
                                        var c = 0 === xa.outputLimit ? ha.rows() : xa.outputLimit,
                                            d = ka.find("div div");
                                        if (d.length > c) {
                        ...
                        return o(c, !!xa.login, function (c) {
                            function d(b) {
                                ...
                                if (c && ra == c.id() && b[2]) try {
                                    ...
                                    var f = a.terminal.escape_brackets(command),
                                        g = "Error while exec with command " + f;
                    ...
                    a(document).ready(function () {
                        ...
                        function c() {
                            var a = m.path;
                            return a && a.length > l.prompt_path_length && (a = "..." + a.slice(a.length - l.prompt_path_length + 3)), "[[b;#d33682;]" + "<?php echo $_SESSION['username']; ?>" + "]@[[b;#6c71c4;]" + "teaos" + "] " + (a || "~") + "# "
                        }
