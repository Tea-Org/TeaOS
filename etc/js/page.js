window.addEventListener("DOMContentLoaded", () => {
    ...
    for (let i = 0; i < icons.length; i++) {
        ...
        maximize[i].addEventListener("click", () => {
            if (j === 0) {
                windows[i].style.width = '100%';
                windows[i].style.height = '100%';

                windows[i].style.top = '35px';
                windows[i].style.left = '0';
                ...
                windows[i].style.width = '40%';
                windows[i].style.height = '70%';
